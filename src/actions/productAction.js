...
export const getProduct =(keyword="",currentPage=1,price=[0,10000],category,ratings=0) =>async (dispatch) => {
    try {
      ...
      let link = `https://shoppingo-backend-harsh.herokuapp.com/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&rating[gte]=${ratings}`;
      ...
      link = `https://shoppingo-backend-harsh.herokuapp.com/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&rating[gte]=${ratings}`;
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    let link=`/api/v1/product/https://shoppingo-backend-harsh.herokuapp.com/${id}`
